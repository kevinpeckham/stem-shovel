...
- **Idea Recorder controls**: the title field is always visible, prefilled "Untitled Recording - <date> - <time>"; Record/Pause/Resume, Stop, Undo (Retake once a take is ready) and Save form one row that never changes shape, each greyed out until it applies; Save works from Paused and stops the take first.
