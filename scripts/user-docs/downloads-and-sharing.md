...
The row under the player offers:
...
- **Demos**: listen to or download the song's demo recordings.
...
By default every song's address works for anyone, signed in or not, so sending the link is sharing. The share button in the song's header emails the link with a note from you.
...
A viewing link lets people listen and read. Editing and commenting still need an account.
