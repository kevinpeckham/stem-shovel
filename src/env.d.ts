...
type _CoercedEnvSchema_f81f6c96 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_f81f6c96> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_f81f6c96, 'VERCEL_ENV' | 'VERCEL_PROJECT_PRODUCTION_URL' | 'APP_ENV' | 'BLOB_STORE_ID' | 'BLOB_WEBHOOK_PUBLIC_KEY' | 'TURSO_DATABASE_URL'>> {}
}
...
type _EnvSchemaAsStrings_f81f6c96 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_f81f6c96 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_f81f6c96 {}
  }
}