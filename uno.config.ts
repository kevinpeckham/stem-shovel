...
export default defineConfig({
	...
	shortcuts: [
		...
		[
			...
			before-block
			before-content-['_']
			before-i-ph-pause-fill
			before-bg-blue-100/70`,
		],
		[
			"device-button-bump-up",
			`
			relative
			before-block
			before-content-['_']
			before-i-ph-triangle-fill
			before-bg-slate-800
			before-text-2.5em
			before-leading-none
			rotate-90`,
		...
		[
			"device-button-skip-back",
			`
			before-block
			before-content-['_']
			before-i-ph-skip-back-fill
			before-bg-blue-100/70`,
		],
		[
			"device-button-loop",
